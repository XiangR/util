...
public class AlipayCoreTest {
	...
	public static String getOrderInfo(String subject, String body, String price) {
		...
		// 服务器异步通知页面路径
		// orderInfo += "&notify_url=\"http://www.sidlu.com\"";
		orderInfo += "&notify_url=\"http://ispinning.cn\"";
		...
		// orderInfo += "&show_url=\"http://www.sidlu.com/\"";
		orderInfo += "&show_url=\"http://ispinning.cn/\"";
